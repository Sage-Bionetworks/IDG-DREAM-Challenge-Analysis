...
ensemble_scores <- bind_rows(median_results_spearman, mean_results_spearman, rank_results_spearman)  %>%  
  ...
  mutate(label = case_when(iteration == 1 & ensemble_model == "spearman_rank_ensemble"  ~ "Q.E.D.",
                           iteration == 2 & ensemble_model == "spearman_rank_ensemble"  ~ "1 + Gregory Koytiger",
                           iteration == 3 & ensemble_model == "spearman_rank_ensemble" ~ "2 + AI Winter is Coming",
                           iteration == 4 & ensemble_model == "spearman_rank_ensemble" ~ "3 + Oliver Labayle", 
                           iteration > 4 | ensemble_model != "spearman_rank_ensemble" ~ ""))
