...
ids <- tibble::tribble(
  ~id, ~lower_limit, ~upper_limit, ~is_random, ~random_iteration, ~exp_label, ~no_of_removed,
  "syn20825281", 1, 14, F, NA, "no limit", 0,
  "syn20825274", 1, 8,  F, NA, "1<Kd<8", 6726,
  "syn20825278", 5.5, 8.5, F, NA, "5.5<Kd<8.5", 16126, 
  "syn20825275", 5, 14, F, NA, "5<Kd<14", 3096, 
  "syn20825279", 5, 9, F, NA, "5<Kd<9", 4774, 
  "syn20825280", 6, 8, F, NA, "6<Kd<8", 29933)
...
data_df_summary <- data_df %>% 
  ...
  group_by(exp_label,lower_limit, upper_limit, is_random, no_of_removed) %>% 
